...
(1, 10001, 'HUAWEI nova3', 2999, '0', 0, 'HUAWEI.png', '此仅为支付测试商品 拍下不会发货\n', 10, '', 'nova3.jpg', 'HUAWEI nova3 6GB+128GB 全网通版（星耀版·樱草金）'),
...
INSERT INTO `goodsimages` (`id`, `src`, `productId`) VALUES
  (1, 'HUAWEI.jpg', '10001'),
  (2, 'HUAWEI1.jpg', '10001'),
  (3, 'HUAWEI2.jpg', '10001'),
  (4, 'HUAWEI3.jpg', '10001'),
  (5, 'HUAWEImain.jpg', '10001');
